<?php
// backend/api/hidrantes.php

require_once __DIR__ . '/cors.php';
handleCors();

require_once __DIR__ . '/../../app/Controllers/HidranteController.php';
...
$controller = new HidranteController();
...
switch ($method) {
    case 'GET':
        if ($id !== null && $id > 0) {
            ...
            if ($result === null) {
                respond(['error' => 'Hidrante no encontrado.', 'success' => false], 404);
                break;
            }
            respond(['success' => true, 'data' => $result]);
            break;
        }
        respond(['success' => true, 'hidrantes' => $controller->listar()]);
        break;
    ...
    case 'PATCH':
        if ($id === null || $id <= 0) {
            respond(['error' => 'Debe proporcionar el id del hidrante.', 'success' => false], 400);
            break;
        }
